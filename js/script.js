...
document.addEventListener('DOMContentLoaded', function () {
	...
	// Инициализация фильтрации отзывов
	initReviewsFilter();

	// Инициализация рейтинга
	initRatingStars();

	// Инициализация вкладок техподдержки
	initSupportTabs();
...
function initAuthForms() {
	...
	if (registerForm && document.getElementById('reg-password')) {
...
function initSupportTabs() {
	...
	if (supportButtons.length > 0 && supportContainers.length > 0) {
